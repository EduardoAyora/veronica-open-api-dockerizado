...
public class OperationController {
    ...
    public ResponseEntity<Object> insertDigitalCert(
            ...
            @Valid @ApiParam(value = API_DOC_ANEXO_1, required = true) @RequestBody com.rolandopalermo.facturacion.ec.service.custom_models.CertificadoDigitalCustomDTO certificadoDigital) {
                System.out.println(certificadoDigital.getPassword());
